                ...
                <#--表单-->
                    <form class="form-horizontal" id="post_form">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label my-control-label ">井盖名称：</label>
                            <div class="col-sm-6">
                                <input type="text" name="manhole" maxlength="64" id="manhole" placeholder="井盖名称" class="form-control">
                            </div>
                            <div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label my-control-label ">所在街道：</label>
                            <div class="col-sm-6">
                                <input type="text" name="street" maxlength="64" id="street" placeholder="所在街道" class="form-control">
                            </div>
                            <div>
                                <i class="i_context my-i_context">*</i>
                            </div>
...
//        });
    ...
    function findList() {
        ...
        var urls="/api/manhole";
        dataTable=zudp.plugin.table('#post-list-table')
                .url(urls)
                .search(function () {
                    return {
                        "manhole":$("#search_name").val()

                    }
                })
                .columns( [
                    {data: 'id',visible: false},
                    {data: 'manhole',width: '25%'},
                    {data: 'street',width: '40%' },
                    {
