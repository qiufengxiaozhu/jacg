        ...
        <div class="modal-content">
            ...
            <small class="font-bold">
                <div class="modal-body fix-height" style="height: 350px">
                    <#--表单-->
                    <form class="form-horizontal" id="integrate_form">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label my-control-label ">积分数：</label>
                            <div class="col-sm-6">
                                <input type="text" name="points" maxlength="64" id="points" placeholder="积分数" class="form-control">
                            </div>
                            <div>
                                <i class="i_context my-i_context">*</i>
                            </div>
...
<script>
    ...
    var dataTable;
    var urlstr="/api/integrate";
    var formIdStr="#integrate_form";
